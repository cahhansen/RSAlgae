...
FormatCalibrationReflectanceData <- function(data){
  ...
  data=data[!(data$Method=="Chlorophyll-A Uncorrected for pheophytin"),]
  ###################################################################################
  ...
  data=data[(data$NIR>0 & data$SWIR1>0 & data$SWIR2>0),]
