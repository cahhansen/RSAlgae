...
dataframe=dataframe[(dataframe$Month=="7"|dataframe$Month=="8"|dataframe$Month=="9"),]
timewindow=1
...
mod=glm(FieldValue~Blue+Red_SWIR2+Green_SWIR1,data=moddataframe,family=gaussian(link="log"))
