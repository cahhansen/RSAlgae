...
basefolder = 'C:/Users/carly/Google Drive/University of Utah - Research/Dissertation Research/'
# Specify location of file with the dates to match the imagery to
samplingfile = basefolder+'Field Data/GSLSWSChlData_Gilbert.csv'
...
for m in range(0,length):
    ...
    stations = ee.FeatureCollection('ft:1x46JxgxBWyMoSqRKQzsinmJ_pA_GX4eYNN2NFx4z').filterMetadata('StationID', 'equals', Station)
...
print('Number of successful matches: '+str(len(pixel_df)))
pixel_df.to_csv(basefolder+'RemoteSensingPaper/ReflectanceValues/SurfaceReflectanceData/LS5-7EarthEngineExport_GSL.csv',index=False)
